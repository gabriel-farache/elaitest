...
## Running elaitest in Quarkus dev mode
...
```
(elaitest should be included in the returned array)

Run the following to create an instance of the elaitest workflow:

```shell script
curl -XPOST -H "Content-Type: application/json" http://localhost:8080/elaitest -d@input.json
```
